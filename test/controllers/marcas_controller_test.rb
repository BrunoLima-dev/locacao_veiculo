...
class MarcasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create marca" do
    assert_difference('Marca.count') do
      post marcas_url, params: { marca: { nome: @marca.nome, veiculo_id: @marca.veiculo_id } }
    end
  ...
  test "should update marca" do
    patch marca_url(@marca), params: { marca: { nome: @marca.nome, veiculo_id: @marca.veiculo_id } }
