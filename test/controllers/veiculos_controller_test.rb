...
class VeiculosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create veiculo" do
    assert_difference('Veiculo.count') do
      post veiculos_url, params: { veiculo: { cor: @veiculo.cor, nome: @veiculo.nome, placa: @veiculo.placa, qnt_passageiros: @veiculo.qnt_passageiros, valor: @veiculo.valor } }
    end
  ...
  test "should update veiculo" do
    patch veiculo_url(@veiculo), params: { veiculo: { cor: @veiculo.cor, nome: @veiculo.nome, placa: @veiculo.placa, qnt_passageiros: @veiculo.qnt_passageiros, valor: @veiculo.valor } }
